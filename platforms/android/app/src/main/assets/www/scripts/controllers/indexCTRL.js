...
'home-module','core-service','request-module','roomsharing-module','room-module','tenant-module','np-module','rent-module','pay-module','success-module','receipt-module','rentPay-module','schedular-module',
'login-service','registration-service','request-service','roomsharing-service','room-service','tenant-service','noticeperiod-service','rent-service','dashboard-service','pay-service','suscription-service','schedular-service'
]);
